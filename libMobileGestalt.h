...
CFPropertyListRef MGCopyMultipleAnswers(CFArrayRef questions, int __unknown0);
     ...
     */
//static int MGSetAnswer(CFStringRef question, CFTypeRef answer);
    
#pragma mark - Identifying Information
    static const CFStringRef kMGN78 = CFSTR("N78");
...
#pragma mark - More Device Capabilities
    ...
    static const CFStringRef kMGn78aHack = CFSTR("+bL/lKwaIAv+fzmjsHYZdw");
    static const CFStringRef kMGn78aMode = CFSTR("W5kTfIuxkKpHVdWTk42C9A");
